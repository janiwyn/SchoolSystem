...
$expectedQuery = "SELECT SUM(expected_tuition) as total FROM student_payments";
...
while ($currentDate <= $endDateTime) {
    $dateRange[$currentDate->format('Y-m-d')] = [
        'expected' => 0,
        'received' => 0,
        'balance'  => 0,   // NEW: per-day unpaid balance
        'admitted' => 0,
        'expenses' => 0
    ];
...
// NEW: 1b) Unpaid balance per day (from student_payments.balance)
$balanceQuery = "SELECT
    DATE(payment_date) as chart_date,
...
// 2) Expected tuition per day (from admit_students on admission date)
...
// 1) Expected tuition from admitted_students
...
// 2) Received amounts from student_payments
...
<div id="adminStatsCarousel" class="carousel slide stats-carousel mb-4">
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <div class="row g-4">
                ...
                <!-- you can add more extra cards on this slide later -->
            </div>
        </div>
    </div>
    ...
    <div class="carousel-indicators stats-carousel-indicators">
        <button type="button"
                data-bs-target="#adminStatsCarousel"
                data-bs-slide-to="0"
                class="active"
                aria-current="true"
